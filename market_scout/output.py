...
def print_table(listings: Sequence[Listing], show_images: bool = False,
                original_prices: dict | None = None) -> None:
    if not listings:
    ...
    table.add_column("Price", style="green", min_width=10, max_width=16, no_wrap=True)
    ...
    for i, lst in enumerate(sorted_listings, 1):
        ...
        # Add ≈ prefix if this price was converted from another currency
        if lst.url in original_prices:
